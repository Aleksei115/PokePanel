...
//Podemos obtener el pokemon de lado del servidor
//Podemos obtener el pokemos desde el cliente usando el tipio fetch con useEffect

//getStaticPaths es requrido para paginas que tienen argumentos dinamicos (en la url) pero que tienen informacion estatica
//La cantidad de paths que se tengan son la cantidad de paginas

//El fallback si es false, regresa un 404, true, trata de hacer algo y "blocking" igual deja pasar
